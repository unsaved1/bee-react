    ...
    return (
        <section className="how-order">
            <div className="container">
                ...
                <Grid className='how-order__steps' display='grid' gridTemplateColumns='repeat(2, 1fr)'>
                    <Grid sx={{textAlign: 'right'}} className="how-order__item how-order__item_left" item xs>
                    ...
                    <Grid item xs/>
                    <Grid item xs className='how-order__item how-order__item_left'/>
