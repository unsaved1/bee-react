...
const facebookIcon =    <svg width="13" height="25" viewBox="0 0 13 25" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10.6636 4.15104H12.9458V0.176042C12.5521 0.121875 11.1979 0 9.62085 0C6.33022 0 4.07606 2.06979 4.07606 5.87396V9.375H0.444809V13.8187H4.07606V25H8.52814V13.8198H12.0125L12.5656 9.37604H8.5271V6.31458C8.52814 5.03021 8.87397 4.15104 10.6636 4.15104Z" fill="white"/>
                        </svg>;
const instagramIcon =   <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M19.893 5.59312C19.893 6.38795 19.2485 7.03242 18.4535 7.03242C17.6587 7.03242 17.0142 6.38795 17.0142 5.59312C17.0142 4.7981 17.6587 4.15381 18.4535 4.15381C19.2485 4.15381 19.893 4.7981 19.893 5.59312Z" fill="white"/>
                            </g>
                            <defs>
...
const pinterestIcon =   <svg width="20" height="24" viewBox="0 0 20 24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10.326 0C3.74699 0.001 0.249992 4.216 0.249992 8.812C0.249992 10.943 1.44099 13.602 3.34799 14.445C3.89199 14.69 3.81999 14.391 4.28799 12.601C4.32499 12.452 4.30599 12.323 4.18599 12.184C1.45999 9.031 3.65399 2.549 9.93699 2.549C19.03 2.549 17.331 15.131 11.519 15.131C10.021 15.131 8.90499 13.955 9.25799 12.5C9.68599 10.767 10.524 8.904 10.524 7.655C10.524 4.507 5.83399 4.974 5.83399 9.145C5.83399 10.434 6.28999 11.304 6.28999 11.304C6.28999 11.304 4.78099 17.4 4.50099 18.539C4.02699 20.467 4.56499 23.588 4.61199 23.857C4.64099 24.005 4.80699 24.052 4.89999 23.93C5.04899 23.735 6.87299 21.133 7.38399 19.252C7.56999 18.567 8.33299 15.787 8.33299 15.787C8.83599 16.695 10.286 17.455 11.831 17.455C16.427 17.455 19.749 13.415 19.749 8.402C19.733 3.596 15.62 0 10.326 0V0Z" fill="white"/>
                        </svg>;
...
const AppHeader = () => {
    ...
    const headerLogo = window.innerWidth <= 768 ? null :    <Link to='/'>
                                                                <div className="header__logo">
                                                                    <img src={logo} alt="logo"/>
                                                                </div>
                                                            </Link>
    const onToggleBurgerMenu = (mode) => {
            setBurgerMenuMode(mode => !mode);
            document.body.style.overflowY = mode ? 'scroll' : 'hidden';
    };

    const headerBurger = window.innerWidth <= 768 ? <button onClick={() => onToggleBurgerMenu(burgerMenuMode)} className="header__burger">
                                                        <span></span>
                                                        <span></span>
                                                        <span></span>
                                                    </button>  :  null  
    ...
    return (
        <div style={burgerMenuMode ? headerBurgerStyle.header : null} className="header">
            {headerLogo}
            {headerBurger}
            <nav className='header__nav'>
                <ul onClick={() => onToggleBurgerMenu(mode => !mode)}>
            ...
            <ul onClick={() => onToggleBurgerMenu(mode => !mode)} className="header__social">
