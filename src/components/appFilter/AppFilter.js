...
const AppFilter = ({categoryValues = [], catalogData, func}) => {
    ...
    const setCategoryValues = () => {
        const categoryArr = categoryValues.map((value, i) => {
            ...
            <div className="container">
                <div className="filter__wrapper">
                    <div className="filter__category">
                        <FormControl>
                            <form action="#">
                                <NativeSelect variant='outlined' defaultValue={category.bee} className='filter__category-select'>
                                    {category}
                                </NativeSelect>
                    ...
                    <div className="filter__sorting-search-wrapper">
                        <div className="filter__search">
                            ...
                            <button onClick={e => func(e)} type="submit">
                        ...
                        <FormControl>
                                <NativeSelect sx={{fontSize: 14, fontWeight: '300', width: 210, height: 32,  ":after": {
                                    borderBottom: 'none'
